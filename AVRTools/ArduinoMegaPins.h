...
#define pPin02 GpioPinPwm(E, 4u, 3, B) // PE4, INT4, OC3B
#define pPin03 GpioPinPwm(E, 5u, 3, C) // PE5, INT5, OC3C
#define pPin04 GpioPinPwm(G, 5u, 0, B) // PG5, OC0B
#define pPin05 GpioPinPwm(E, 3u, 3, A) // PE3, AIN1, OC3A

#define pPin06 GpioPinPwm(H, 3u, 4, A) // PH3, OC4A, PCINT8
#define pPin07 GpioPinPwm(H, 4u, 4, B) // PH4, OC4B
#define pPin08 GpioPinPwm(H, 5u, 4, C) // PH5, OC4C
#define pPin09 GpioPinPwm(H, 6u, 2, B) // PH6, OC2B
#define pPin10 GpioPinPwm(B, 4u, 2, A) // PB4, OC2A, PCINT4

#define pPin11 GpioPinPwm(B, 5u, 1, A) // PB5, OC1A, PCINT5
#define pPin12 GpioPinPwm(B, 6u, 1, B) // PB6, OC1B, PCINT6
#define pPin13 GpioPinPwm(B, 7u, 0, A) // PB7, OC0A, PCINT7
